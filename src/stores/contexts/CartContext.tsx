import { loadSubscribersFromStorage } from '@/helpers/globalHelpers'
...
interface ICartContext {
	...
	getSubscribeDiscount: (email: string) => number
...
export const CartContextProvider = ({ children }: any) => {
	...
	const getSubscribeDiscount = (email?: string): number => {
		if (!email) return 0
